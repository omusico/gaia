...
describe SearchController do
  ...
  describe "index" do
    ...
    describe "by :zipcode" do
      before do
        @dist = FactoryGirl.create :dist, :zipcode => 100
        dist = FactoryGirl.create :dist, :zipcode => 200
      end
    ...
    describe "by :text" do
      ...
      before do
        @city = FactoryGirl.create :city, :name => "台北"
        @city2 = FactoryGirl.create :city, :name => "台南"
        @city_name_alias = FactoryGirl.create :city_name_alias, :name => "北縣", :city_id => @city.id
        @city_name_alias2 = FactoryGirl.create :city_name_alias, :name => "南市", :city_id => @city2.id
        @dist = FactoryGirl.create :dist, :city_id => @city.id, :name => "淡水"
        @dist2 = FactoryGirl.create :dist, :city_id => @city2.id, :name => "中西區"
        @dist_name_alias = FactoryGirl.create :dist_name_alias, :name => "阿給", :dist_id => @dist.id
        @dist_name_alias2 = FactoryGirl.create :dist_name_alias, :name => "中區", :dist_id => @dist2.id
        @text = "這裡是台南市的中區"
